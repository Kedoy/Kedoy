...
**Студент 2 курса Программной инженерии (ПетрГУ).** Занимаюсь Fullstack-разработкой и автоматизацией бизнес-процессов. Люблю доводить код до работающего в продакшене сервиса.
...
* **Iriska Studio** — Fullstack сайт-визитка с настроенным CI/CD, Nginx и SSL в Docker-контейнерах.
* **Ks Financial Assistant** — (Курсовая) Экосистема учета финансов с аналитикой и автоматическим чтением банковских SMS.
* **Buyballbot** — Продажа билетов через Telegram WebApp с кастомной админ-панелью.
